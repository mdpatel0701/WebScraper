	...
	public static void main(String[] args) {
		...
		while (!isValidUserInput) {
			try {
				...
				System.out.println("Sorted Word Map size: " + sortedWordMap.size() + "\n");
				...
				/***** Get Word List *****/
				/*
				 * System.out.println("Word List:"); String[] wordlist =
				 * webObj.getWordList(webContent); int count=1; for(String word: wordlist) {
